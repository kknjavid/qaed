...
var descText = [
  ...
  customText(
      "\nنرم افزار پیش رو مجموعه بیانات مقام معظم رهبری دام ظله از سال ۶۸ تا تاریخ ۲۱ اریبهشت ۱۴۰۱ می باشد؛ که به روش برنامه نویسی از سایت رسمی مقام معظم رهبری دام ظله استخراج گردیده است."),
  customText(
